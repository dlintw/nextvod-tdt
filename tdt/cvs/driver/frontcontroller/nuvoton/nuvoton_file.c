...
#if defined(ATEVIO7500) || defined(HS7810A) || defined(HS7110) || defined(ATEMIO520) || defined(ATEMIO530)
...
#if !defined(HS7810A) && !defined(HS7110) && !defined(ATEMIO520) && !defined(ATEMIO530)
    if (level < 0 || level > 7)
    {
