...
if STM22
	cp $(kernelprefix)/linux/drivers/usb/serial/ftdi_sio.ko $(prefix)/release_neutrino/lib/modules/ftdi.ko
	cp $(kernelprefix)/linux/drivers/usb/serial/pl2303.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/drivers/usb/serial/usbserial.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/fs/autofs4/autofs4.ko $(prefix)/release_neutrino/lib/modules
else
...
if !STM22
	...
	cp $(kernelprefix)/linux/fs/autofs4/autofs4.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/drivers/net/tun.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/drivers/usb/serial/cp2101.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/fs/cifs/cifs.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/fs/ntfs/ntfs.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/fs/nfsd/nfsd.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/fs/exportfs/exportfs.ko $(prefix)/release_neutrino/lib/modules
	cp $(kernelprefix)/linux/fs/nfs_common/nfs_acl.ko $(prefix)/release_neutrino/lib/modules
...
if ENABLE_PLAYER191
	...
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/stgfb/stmfb/stmvbi.ko $(prefix)/release_neutrino/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/stgfb/stmfb/stmvout.ko $(prefix)/release_neutrino/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/player2-unified.ko $(prefix)/release_neutrino/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/pti/pti.ko $(prefix)/release_neutrino/lib/modules/
#	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/pti_np/pti.ko $(prefix)/release_neutrino/lib/modules/
	find $(prefix)/release_neutrino/lib/modules/ -name '*.ko' -exec sh4-linux-strip --strip-unneeded {} \;
	cd $(targetprefix)/lib/modules/$(KERNELVERSION)/extra && \
