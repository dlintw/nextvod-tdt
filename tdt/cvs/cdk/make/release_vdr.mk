...
if !STM22
	...
	rm -f $(prefix)/release_vdr/bin/{stslave,ustslave}
else
	rm -f $(prefix)/release_vdr/bin/ustslave_stm23
endif
...
if ENABLE_FORTIS_HDBOX
	...
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/sound/pseudocard/pseudocard.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/sound/silencegen/silencegen.ko $(prefix)/release_vdr/lib/modules/
	...
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/stm/mmelog/mmelog.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/stm/monitor/stm_monitor.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/media/video/stm/stm_v4l2.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/media/dvb/stm/dvb/stmdvb.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/sound/ksound/ksound.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/media/dvb/stm/mpeg2_hard_host_transformer/mpeg2hw.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/media/dvb/stm/backend/player2.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/media/dvb/stm/h264_preprocessor/sth264pp.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/media/dvb/stm/allocator/stmalloc.ko $(prefix)/release_vdr/lib/modules/
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/stm/platform/platform.ko $(prefix)/release_vdr/lib/modules/
...
if !STM22
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/player2/linux/drivers/stm/platform/p2div64.ko $(prefix)/release_vdr/lib/modules/
endif
