...
HOST_U_BOOT_RAWVERSION := 1.1.2_stm22_0020
HOST_U_BOOT_DIR := u-boot/u-boot-1.1.2_stm22_0020
...
HOST_U_BOOT_RAWVERSION := sh4-1.3.1_stm23_0038-38
HOST_U_BOOT_DIR := u-boot/u-boot-sh4-1.3.1_stm23_0038
HOST_U_BOOT_SPEC := stm-$(HOST_U_BOOT).spec
HOST_U_BOOT_SPEC_PATCH :=
HOST_U_BOOT_PATCHES :=
else !STM23
# if STM24
HOST_U_BOOT_VERSION := sh4-1.3.1_stm24_0047-47
HOST_U_BOOT_RAWVERSION := sh4-1.3.1_stm23_0047-47
HOST_U_BOOT_DIR := u-boot/u-boot-sh4-1.3.1_stm24_0047
HOST_U_BOOT_SPEC := stm-$(HOST_U_BOOT).spec
HOST_U_BOOT_SPEC_PATCH :=
HOST_U_BOOT_PATCHES :=
# endif STM24
