...
UFS910PATCHES_24 = $(COMMONPATCHES_24) \
		$(if $(P0209),linux-sh4-mmap_stm24.patch) \
		$(if $(P0210),linux-sh4-mmap_stm24.patch) \
		$(if $(P0209),linux-sh4-remove_pcm_reader_stm24.patch) \
		$(if $(P0210),linux-sh4-remove_pcm_reader_stm24.patch) \
