...
do
  ...
  do
    ...
    do
       ...
       mount $fstype $device $dboxmountpoint
       echo "mount $fstype $device $dboxmountpoint"
       ...
       wlist="$wlist$throughput $throughputinkb kbps $throughputinkB kBps\n"
       ...
       rlist="$rlist$throughput $throughputinkb kbps $throughputinkB kBps\n"
       echo
    done
  done
done
