...
static struct mtd_partition onboard_partitions[9] = {
	...
	{ ifelse(rootfs,`cramfs',`
	 .name = "Root CRAMFS-           0xA02A.0000-`'endaddr(0x2A0000 + rootsize - 0x1)",',rootfs,`squashfs',`
	 .name = "Root SQUASHFS-         0xA02A.0000-`'endaddr(0x2A0000 + rootsize - 0x1)",',rootfs,`focramfs',`
	 .name = "Root CramfsOverlay-    0xA02A.0000-`'endaddr(0x2A0000 + rootsize - 0x1)",',rootfs,`fosquashfs',`
	 .name = "Root SquashfsOverlay-  0xA02A.0000-`'endaddr(0x2A0000 + rootsize - 0x1)",',rootfs,`jffs2',`
	 .name = "Root JFFS2-            0xA02A.0000-`'endaddr(0x2A0000 + rootsize - 0x1)",',`
	...
	{ ifelse(rootfs,`cramfs',`
	 ...
	 .name = "OtherData Var          `'startaddr(0x1000000 - datasize)-`'endaddr(0x1000000 - 0x1)",',rootfs,`focramfs',`
	 .name = "OtherData Overlay      `'startaddr(0x1000000 - datasize)-`'endaddr(0x1000000 - 0x1)",',rootfs,`fosquashfs',`
	 .name = "OtherData Overlay      `'startaddr(0x1000000 - datasize)-`'endaddr(0x1000000 - 0x1)",',rootfs,`jffs2',`
