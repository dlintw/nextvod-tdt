...
AC_ARG_WITH(boxtype,
	[  --with-boxtype=NAME box type [[dbox2,tripledragon,generic,dm7000,dm500,dm56x0,dm600pvr,ipbox...]]],
...
AM_CONDITIONAL(BOXTYPE_DREAMBOX, test "$BOXTYPE" != "dbox2" -a "$BOXTYPE" != "ipbox" -a "$BOXTYPE" != "tripledragon" -a "$BOXTYPE" != "generic")
...
if test "$BOXTYPE" = "dbox2"; then
	...
	AC_DEFINE(HAVE_IPBOX, 1, [building for a ipbox])
