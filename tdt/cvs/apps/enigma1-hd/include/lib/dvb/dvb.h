...
//			eDebug("Satellite Data is equal");
	...
	void setSatellite(int frequency, int symbol_rate, int polarisation, int fec, int orbital_position, int inversion, int system, int modulation, int rolloff, int pilot);
