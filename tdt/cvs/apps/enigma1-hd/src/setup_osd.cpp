...
void eZapOsdSetup::init_eZapOsdSetup()
{
	...
	sAlpha = new eSlider( this, l, 0, 255 );
	...
	l = new eLabel(this);
	l->setText(_("Background:"));
	l->move(ePoint(20, 100));
	l->resize(eSize(120, fd+4));
	sBrightness = new eSlider( this, l, 0, 100 );
	sBrightness->setIncrement( 20 ); // Percent !
	sBrightness->move( ePoint( 150, 100 ) );
	sBrightness->resize(eSize( 290, fd+4 ) );
	sBrightness->setHelpText(_("change the background color"));
