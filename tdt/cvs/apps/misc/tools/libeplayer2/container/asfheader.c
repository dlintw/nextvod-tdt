...
// PUT_UTF8 extracted from common.h
...
#ifdef __sh__
unsigned char ASF_PRIVATE_DATA[4];
...
#ifdef __sh__
        // ASF PRIVATE DATA
        memcpy(&ASF_PRIVATE_DATA, &buffer[4+4+1+2+40], 4);
#endif
