...
#if defined(__sh__)
			int x0 = region->region_horizontal_address*m_vsize/720;
			int y0 = region->region_vertical_address*m_hsize/576;
#else
...
#if defined(__sh__)
int eDVBSubtitleParser::start(int pid, int composition_page_id, int ancillary_page_id, eSize size)
#else
