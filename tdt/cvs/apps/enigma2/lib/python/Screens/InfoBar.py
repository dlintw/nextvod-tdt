...
#---<
#+++>
	InfoBarAspectSelection, InfoBarResolutionSelection, InfoBarSubserviceSelection, InfoBarTimeshift, InfoBarSeek,
#+++<
...
class MoviePlayer(InfoBarBase, InfoBarShowHide, \
		...
		InfoBarServiceErrorPopupSupport, InfoBarExtensions, InfoBarPlugins, InfoBarAspectSelection, InfoBarResolutionSelection):
	...
	def __init__(self, session, service):
		...
		for x in HelpableScreen, InfoBarShowHide, InfoBarMenu, \
				...
				InfoBarPlugins, InfoBarAspectSelection, InfoBarResolutionSelection:
			x.__init__(self)
