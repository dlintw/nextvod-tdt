...
class EventViewBase:
	...
	def __init__(self, Event, Ref, callback=None, similarEPGCB=None):
		...
		self["EventShort"] = Label()
		self["EventInfo"] = ScrollLabel()
		#<+++ TDT
		self["key_red"] = Button("")
	...
	def setEvent(self, event):
		...
		#+++> TDT
		self["EventName"].setText(text)
		#<+++ TDT
		short = event.getShortDescription()
		#+++> TDT
		self["EventShort"].setText(short)
		#<+++ TDT
		ext = event.getExtendedDescription()
		#+++> TDT
		self["EventInfo"].setText(ext)
		#<+++ TDT
	...
	def pageUp(self):
		...
		self["EventInfo"].pageUp()
		#<+++ TDT

	def pageDown(self):
		#+++> TDT
		# self["epg_description"].pageDown()
		self["EventInfo"].pageDown()
		#<+++ TDT
