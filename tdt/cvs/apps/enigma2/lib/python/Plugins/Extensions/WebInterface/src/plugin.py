Version = '$Header: /var/lib/gforge/chroot/cvsroot/enigma2-plugins/enigma2-plugins/webinterface/src/plugin.py,v 1.93 2009-09-05 07:08:36 sreichholf Exp $';
...
running_defered = []
waiting_shutdown = 0
server.VERSION = "Enigma2 WebInterface Server $Revision: 1.93 $".replace("$Revi", "").replace("sion: ", "").replace("$", "")
