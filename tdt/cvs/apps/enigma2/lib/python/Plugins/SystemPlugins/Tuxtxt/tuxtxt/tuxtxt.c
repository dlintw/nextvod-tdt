...
static void sbSigHandler(int signo)
{
	...
	unlink ("/tmp/rc.socket");
 	fprintf(stderr, "Tuxtxt dies with signal %d\n", signo);
...
int main(int argc, char **argv)
{
	...
	{
	    fprintf(stderr, "!!!!!!!!!!!! Failed to create thread !!!!!!!!!!!!11\n");
	} else
	    fprintf(stderr, "!!!!!!!!!!!! create thread !!!!!!!!!!!!11\n");
...
/* init data */
	...
	fprintf(stderr, "sx %d, ex %d, sy %d, ey %d\n", sx, ex, sy, ey);
	...
	fprintf(stderr, "StartX %d, StartY %d, displaywidth %d\n", StartX, StartY, displaywidth);
